...
public class SharedTasksAdapter extends BaseAdapter {
    private List<TaskModel> objects;
    private LayoutInflater inflater;

    public SharedTasksAdapter(Activity activity, List<TaskModel> objects) {
    ...
    public SharedTasksAdapter(MainActivity activity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(objects.get(position).getName()!=null) {
            ...
            txt_name.setText(String.valueOf(""));
            txt_deadline.setText(String.valueOf("" ));
            txt_sharedwith.setText(String.valueOf(""));
