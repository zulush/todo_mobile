...
public class PersonalTasksAdapter extends BaseAdapter {
    private List<TaskModel> objects;
    private LayoutInflater inflater;

    public PersonalTasksAdapter(Activity activity, List<TaskModel> objects) {
    ...
    public PersonalTasksAdapter(MainActivity activity) {
